...
/// 
[System.Serializable]
public class UIGeneralTexts : ScriptableObject 
{
    ...
    public UIGeneralTextsData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new UIGeneralTextsData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public UIGeneralTextsData FindByKey(string key)
    //{
