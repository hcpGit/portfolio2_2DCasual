...
/// 
[System.Serializable]
public class Monster_Info : ScriptableObject 
{
    ...
    public Monster_InfoData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Monster_InfoData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Monster_InfoData FindByKey(string key)
    //{
