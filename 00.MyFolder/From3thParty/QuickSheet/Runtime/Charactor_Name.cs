...
/// 
[System.Serializable]
public class Charactor_Name : ScriptableObject 
{
    ...
    public Charactor_NameData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Charactor_NameData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Charactor_NameData FindByKey(string key)
    //{
