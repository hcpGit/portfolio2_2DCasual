...
/// 
[System.Serializable]
public class Client_QuestSay_Normal : ScriptableObject 
{
    ...
    public Client_QuestSay_NormalData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Client_QuestSay_NormalData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Client_QuestSay_NormalData FindByKey(string key)
    //{
