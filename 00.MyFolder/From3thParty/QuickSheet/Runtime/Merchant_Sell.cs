...
/// 
[System.Serializable]
public class Merchant_Sell : ScriptableObject 
{
    ...
    public Merchant_SellData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Merchant_SellData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Merchant_SellData FindByKey(string key)
    //{
