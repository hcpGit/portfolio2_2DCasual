...
/// 
[System.Serializable]
public class Evidence_Info : ScriptableObject 
{
    ...
    public Evidence_InfoData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Evidence_InfoData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Evidence_InfoData FindByKey(string key)
    //{
