...
/// 
[System.Serializable]
public class Merchant_Paper : ScriptableObject 
{
    ...
    public Merchant_PaperData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Merchant_PaperData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Merchant_PaperData FindByKey(string key)
    //{
