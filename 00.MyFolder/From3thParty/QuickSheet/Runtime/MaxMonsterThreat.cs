...
/// 
[System.Serializable]
public class MaxMonsterThreat : ScriptableObject 
{
    ...
    public MaxMonsterThreatData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new MaxMonsterThreatData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public MaxMonsterThreatData FindByKey(string key)
    //{
