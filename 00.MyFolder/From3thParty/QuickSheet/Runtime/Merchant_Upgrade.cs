...
/// 
[System.Serializable]
public class Merchant_Upgrade : ScriptableObject 
{
    ...
    public Merchant_UpgradeData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Merchant_UpgradeData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Merchant_UpgradeData FindByKey(string key)
    //{
