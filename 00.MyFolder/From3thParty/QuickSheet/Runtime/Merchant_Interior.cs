...
/// 
[System.Serializable]
public class Merchant_Interior : ScriptableObject 
{
    ...
    public Merchant_InteriorData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Merchant_InteriorData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Merchant_InteriorData FindByKey(string key)
    //{
