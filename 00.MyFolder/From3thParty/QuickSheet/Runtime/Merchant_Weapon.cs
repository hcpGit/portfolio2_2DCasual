...
/// 
[System.Serializable]
public class Merchant_Weapon : ScriptableObject 
{
    ...
    public Merchant_WeaponData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new Merchant_WeaponData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public Merchant_WeaponData FindByKey(string key)
    //{
